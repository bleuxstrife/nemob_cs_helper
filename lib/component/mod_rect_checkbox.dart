...
///  * [Switch], a widget with semantics similar to [RectCheckbox].
...
class RectCheckbox extends StatefulWidget {
  ...
  @override
  _RectCheckboxState createState() => _RectCheckboxState();
}

class _RectCheckboxState extends State<RectCheckbox>
...
const double _kEdgeSize = RectCheckbox.width + 2.0;
const Radius _kEdgeRadius = Radius.circular(RectCheckbox.width/3);
